...
- [ ] (P0) Align `pass2hash` PBKDF2 defaults with current security guidance: PRF-specific iteration defaults (SHA1/SHA256/SHA512) and updated `--help`/README text. (Impact: high, Effort: low, Strategic fit: high, Differentiation: low, Risk: low, Confidence: medium)
